    ...
    message:
      ...
      properties:
        ...
        uuid:
          ...
          title: Device UUID
          description:
            Unique identifier of the chip. It could be retrieved by BLHOST command from chip or also the debug authentication protocol
        ...
        flags:
          type: [number, string]
          title: Command context flags
          description: "Used to identify the context of the command:\n
            0x0: Baseline API\n
            0x1: SAB API"
          format: number
          template_value: 0x00
                  ...
                  properties:
                    ...
                    key_exchange_algorithm:
                      ...
                      enum:
                        ...
                        - HKDF SHA256
                        - HKDF SHA384
                      template_value: ECDH HKDF SHA256 KEY IMPORT
                    ...
                    oem_private_key:
                      type: string
                      title: OEM Private Key for ECDH
                      description:
                        "Path to OEM P256 private key file (PEM format) used for ECDH key agreement.
                        This key will be used with NXP_PROD_KA_PUB to derive the shared secret and subsequent keys.
                        If provided along with nxp_prod_ka_pub, automatic ECDH key derivation will be performed."
                      format: file
                      template_value: oem_p256_private_key.pem
                    nxp_prod_ka_pub:
                      type: [number, string]
                      title: NXP Production Key Agreement Public Key
                      description: "NXP production key agreement public key.
                        Used together with oem_private_key for ECDH key derivation."
                      format: file
                      template_value: nxp_prod_ka.pub
                    srkh:
                      type: [number, string]
