  ...
  b0:
    features:
      ahab:
        ...
        # B0 revision requires dummy image for OEI DDR
        oei_ddr_gap_after_image: 0
        oei_ddr_qb_data_dummy: True
...
features:
  ...
  dat:
    ...
    clear_iee_config_on_ele: True # Flag to enable configuration for clear IEE configuration with ELE
    ele_cnt_version: 1
  ...
  ahab:
    ...
    signature_algorithms:
      RSA_PSS: [0x22, "RSA_PSS", "RSA PSS signature algorithm"]
      ECDSA: [0x27, "ECDSA", "ECDSA signature algorithm"]
      SM2: [0x28, "SM2", "SM2 signature algorithm"]
      # V2 only
      DILITHIUM: [0xD1, "DILITHIUM", "Dilithium PQC algorithm"]
      ML_DSA: [0xD2, "ML-DSA", "ML-DSA PQC algorithm"]

    hash_algorithms:
      SHA256: [0x00, "SHA256", "SHA-256 hash algorithm"]
      SHA384: [0x01, "SHA384", "SHA-384 hash algorithm"]
      SHA512: [0x02, "SHA512", "SHA-512 hash algorithm"]
      SM3: [0x03, "SM3", "SM3 hash algorithm"]
      # V2 only
      SHA3_256: [0x04, "SHA3_256", "SHA3-256 hash algorithm"]
      SHA3_384: [0x05, "SHA3_384", "SHA3-384 hash algorithm"]
      SHA3_512: [0x06, "SHA3_512", "SHA3-512 hash algorithm"]
      SHAKE_128_256: [0x08, "SHAKE_128_256", "SHAKE-128 with 256-bit output"]
      SHAKE_256_512: [0x09, "SHAKE_256_512", "SHAKE-256 with 512-bit output"]
    ...
    oei_ddr_no_qb_load_address: 0x1ffc0000
    oei_ddr_no_qb_entry_point: 0x1ffc0001
    oei_ddr_no_qb_core_id: cortex-m33
    oei_ddr_no_qb_image_type: oei
    oei_ddr_no_qb_image_size_alignment: 0x400
    oei_ddr_no_qb_gap_after_image: 0x10000
    ...
    spl_ddr_image_size_alignment: 0x400
    ...
    dtb_entry_point: 0x0
    dtb_image_type: data
    dtb_image_size_alignment: 0x400
    ...
    metadata: sm # uses IAE metadata for SM
  ...
  bootable_image:
    ...
    # Template definitions for bootable image generation
    templates:
      imx_boot_flash_all:
        description: "Complete imx-bootloader image"
        mem_type: serial_downloader
        configs:
          - name: spl
            type: spl
            containers:
              - name: nxp_container
                path: "mx95b0-ahab-container.img"
              - name: spl_container
                images:
                  [oei_ddr_no_qb, system_manager, cortex_m7_app, spl, v2x_dummy]
          - name: uboot
            type: uboot
            containers:
              - name: uboot_container
                images: [atf, uboot, tee]
    ...
    boards:
      imx95-15x15-lpddr4x-evk:
        ...
        cortex_m7_app: imx95-15x15-evk_m7_TCM_power_mode_switch.bin
        spl: u-boot-spl.bin-imx95-15x15-lpddr4x-evk-sd
        atf: bl31-imx95.bin
        uboot: u-boot-imx95-15x15-lpddr4x-evk.bin-sd
        tee: tee.bin
      imx95-19x19-lpddr5-evk:
        lpddr_imem: lpddr5_imem_v202409.bin
        lpddr_dmem: lpddr5_dmem_v202409.bin
        lpddr_imem_qb: lpddr5_imem_qb_v202409.bin
        lpddr_dmem_qb: lpddr5_dmem_qb_v202409.bin
        oei_ddr: oei-m33-ddr.bin
        system_manager: m33_image-mx95evk.bin
        cortex_m7_app: imx95-19x19-evk_m7_TCM_power_mode_switch.bin
        spl: u-boot-spl.bin-imx95-19x19-lpddr5-evk-sd
        atf: bl31-imx95.bin
      ...
      imx95-19x19-verdin:
        ...
        oei_ddr: oei-m33-ddr.bin
        system_manager: m33_image-mx95evk.bin
        cortex_m7_app: imx95-verdin-evk_m7_TCM_power_mode_switch.bin
        spl: u-boot-spl.bin-imx95-19x19-verdin-sd
        atf: bl31-imx95.bin
        uboot: u-boot-imx95-19x19-verdin.bin-sd
        tee: tee.bin
