...
features:
  ...
  fcb:
    mem_types:
      flexspi_nor:
        reg_spec: ../mimx9352/fcb_flexspi_nor.json
  ...
  ahab:
    ...
    core_ids:
      ...
      CORTEX_A35_1: [2, "cortex-a35-1", "Cortex A35 1"]
      CORTEX_A35_2: [4, "cortex-a35-2", "Cortex A35 2"]
    ...
    mcu_image_size_alignment: 0x400

    kernel_load_address: 0x80400000
    kernel_core_id: cortex-a35-1
    kernel_meta_data_start_cpu_id: 0
    kernel_chunk_size: 0x700000
    kernel_revisions_to_split: [a0]
    kernel_image_size_alignment: 0x400

    dtb_load_address: 0x83000000
    dtb_core_id: cortex-a35-1
    dtb_meta_data_start_cpu_id: 0
    dtb_entry_point: 0x0
    dtb_image_type: data
    dtb_image_size_alignment: 0x400

    extra_images: [upower, spl, atf, uboot, tee, mcu, kernel, dtb]
