...
features:
  ...
  dat:
    ...
    clear_iee_config_on_ele: False # Flag to enable configuration for clear IEE configuration with ELE
    ...
    enable_power_domains_after_connect: False # Power up system/debug domains after probe connect
    enable_sda_debug_paths_after_connect: False # Enable debug paths through SDA AP after connect
    mem_ap_preserve_csw_ro_bits: False # Preserve MEM-AP CSW read-only bits during memory transfers
    mem_ap_scan_write_before_read: False # Use write-before-read while detecting MEM-AP
  ...
  pfr:
    ...
    cmpa:
      ...
      support_additional_data: False # extra data defined by customer
    cfpa:
      support_additional_data: False # extra data defined by customer
  ...
  memcfg:
    ...
    peripherals:
      ...
      flexspi_nand:
        ...
        instances: []
      xspi_nand:
        reg_spec: ../../common/memcfg/opt_word_xspi_nand.json
        region_number: 0x101
        ow_counts_rule: OptionSize
        runtime_instance: True
        mem_type: nand
  ...
  hse:
    ...
    auth_schemes:
      ...
      - "RSASSA_PKCS1_V15"
      - "RSASSA_PSS"
    smr_regions_count: 32
    rsa_pub_exponent_max_size: 16
    supported_key_types:
      - "SHE"
      - "AES"
      - "HMAC"
