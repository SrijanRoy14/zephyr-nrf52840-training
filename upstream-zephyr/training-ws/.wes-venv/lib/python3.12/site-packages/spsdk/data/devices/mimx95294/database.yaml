...
info:
  ...
  spsdk_predecessor_name: mx952
  web: https://www.nxp.com/products/i.MX-952
  memory_map:
    # M33 Code TCM (256KB)
    code-tcm_ns:
    ...
    system-tcm_s:
      ...
      external: false
      non_xip_type: int_ram
    # M7 DTCM (256KB) - at 0x20000000 for M7 view
    cm7_dtcm_ns:
      start_int: 0x20000000
      size_int: 0x80000
      external: false
      non_xip_type: int_ram
    # M7 ITCM (256KB) - at 0x00000000 for M7 view
    cm7_itcm_ns:
      start_int: 0x00000000
      size_int: 0x80000
      external: false
      non_xip_type: int_ram
    # OCRAM (352KB)
    ...
    ocram_s:
      ...
      external: false
      non_xip_type: int_ram
    # External Serial Peripheral Interface (XSPI1/FlexSPI1)
    flexspi1_ns:
    ...
    # # OCRAM_C (96KB)
    # ocram_c_ns:
    #   start_int: 0x4AF80000
    #   size_int: 0x18000
    #   external: false
    #   mirror_of: ocram_c_s
    #   non_xip_type: int_ram
    # ocram_c_s:
    #   start_int: 0x5AF80000
    #   size_int: 0x18000
    #   external: false
    #   non_xip_type: int_ram
    # # OCRAM_D (36KB)
    # ocram_d_ns:
    #   start_int: 0x4B300000
    #   size_int: 0x9000
    #   external: false
    #   mirror_of: ocram_d_s
    #   non_xip_type: int_ram
    # ocram_d_s:
    #   start_int: 0x5B300000
    #   size_int: 0x9000
    #   external: false
    #   non_xip_type: int_ram
    # DRAM regions (256MB each)
    dram1_ns:
...
features:
  ...
  # ======== DAT section ========
  dat:
    socc: 0x4D5803B8 # SOCC identification
  ...
  fcb:
    mem_types:
      flexspi_nor:
        reg_spec: ../mimx9596/fcb_flexspi_nor.json
  ...
  bootable_image:
      ...
      imx_boot_flash_all:
        ...
        configs:
          - name: spl
            ...
            containers:
              - name: nxp_container
                path: "mx952a0-ahab-container.img"
              - name: spl_container
                images: [oei_ddr_no_qb, system_manager, v2x_dummy, spl]
          - name: uboot
            type: uboot
            containers:
    ...
    boards:
      imx952-15x15-lpddr4x-evk:
        ...
        system_manager: m33_image-mx952evk.bin
        spl: u-boot-spl.bin-imx952-15x15-lpddr4x-evk-sd
        atf: bl31-imx952.bin
        uboot: u-boot-imx952-15x15-lpddr4x-evk.bin-sd
        tee: tee.bin
      imx952-19x19-lpddr5-evk:
        ...
        oei_ddr: oei-m33-ddr.bin
        system_manager: m33_image-mx952evk.bin
        spl: u-boot-spl.bin-imx952-19x19-lpddr5-evk-sd
        atf: bl31-imx952.bin
        uboot: u-boot-imx952-19x19-lpddr5-evk.bin-sd
        tee: tee.bin
